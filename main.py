...
def run_branched(args):
    ...
    prior_color = torch.full(size=(1, mesh.faces.shape[0], 3, 3), fill_value=0.5, device=device)
...
def update_mesh(mlp, network_input, prior_color, sampled_mesh, vertices):
    ...
    # vi0: One could also add small rotation of the normal for greater generality
    #sampled_mesh.vertices = vertices + sampled_mesh.vertex_normals * pred_normal

    aux = copy.copy(sampled_mesh.vertices)

    # Worked with 0.001
    sampled_mesh.vertices = 0.1 * aux + vertices + sampled_mesh.vertex_normals * pred_normal
    ...
    #print('sampled_mesh.vertex_normals')

    #print(sampled_mesh.vertex_normals)

    #print('sampled_mesh.vertex_normals * pred_normal')

    #print(sampled_mesh.vertex_normals * pred_normal)

    #print('sampled_mesh.vertices')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--width', type=int, default=256) #64
    parser.add_argument('--colordepth', type=int, default=2)
    parser.add_argument('--normdepth', type=int, default=2)
    parser.add_argument('--normwidth', type=int, default=256) # 512
    ...
    parser.add_argument('--clipmodel', type=str, default='RN50x4')
